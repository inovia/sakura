...
//		0,		1,		 2(000), 3(001),4(010),	5(011),		6(100),	7(101),		8(110),		9(111)
	...
	{ VKEX_LSD_CLICK,	(LPCWSTR)STR_KEY_BIND_LSD_CLICK,	{ F_TAGJUMPBACK,	F_0,				F_0,					F_0,				F_0,					F_0,				F_0,					F_0 }, }, // novice 2004/10/10 マウスサイドボタン対応
	...
	/* ファンクションキー */
	//keycode,	keyname,			なし,					Shitf+,						Ctrl+,					Shift+Ctrl+,		Alt+,					Shit+Alt+,			Ctrl+Alt+,				Shift+Ctrl+Alt+
	{ VK_F1,	L"F1",			{ F_HSP_SEARCH_KEYWORD,		F_MENU_ALLFUNC,				F_EXTHELP1,				F_ABOUT,			F_HELP_CONTENTS,		F_HELP_SEARCH,		F_EXTHTMLHELP,			F_0 }, },
	...
	{ VK_F4,	L"F4",			{ F_TAGJUMP,				F_TAGJUMPBACK,				F_0,					F_FILECLOSE_OPEN,	F_0,					F_EXITALLEDITORS,	F_EXITALL,				F_0 }, },
	{ VK_F5,	L"F5",			{ F_HSP_COMPILE_RUN,		F_REDRAW,					F_EXECMD_DIALOG,		F_0,				F_UUDECODE,				F_0,				F_TABTOSPACE,			F_SPACETOTAB }, },
	{ VK_F6,	L"F6",			{ F_HSP_RUN,				F_BEGIN_BOX,				F_TOLOWER,				F_BEGIN_SEL,		F_BASE64DECODE,			F_0,				F_0,					F_0 }, },
	{ VK_F7,	L"F7",			{ F_HSP_COMPILE_ONLY,		F_0,						F_TOUPPER,				F_CUT,				F_CODECNV_UTF72SJIS,	F_CODECNV_SJIS2UTF7,F_FILE_REOPEN_UTF7,		F_0 }, },
	{ VK_F8,	L"F8",			{ F_HSP_SHOW_ERR,			F_COPY_CRLF,				F_TOHANKAKU,			F_COPY,				F_CODECNV_UTF82SJIS,	F_CODECNV_SJIS2UTF8,F_FILE_REOPEN_UTF8,		F_0 }, },
	{ VK_F9,	L"F9",			{ F_HSP_CREATE_OBJ,			F_PASTEBOX,					F_TOZENKAKUKATA,		F_PASTE,			F_CODECNV_UNICODE2SJIS,	F_0,				F_FILE_REOPEN_UNICODE,	F_0 }, },
	{ VK_F10,	L"F10",			{ F_HSP_RUN_EXTERNAL,		F_DUPLICATELINE,			F_TOZENKAKUHIRA,		_SQL_RUN,			F_CODECNV_EUC2SJIS,		F_CODECNV_SJIS2EUC,	F_FILE_REOPEN_EUC,		F_0 }, },
	{ VK_F11,	L"F11",			{ F_HSP_LABEL_LIST,			F_ACTIVATE_SQLPLUS,			F_HANKATATOZENKATA,		F_OUTLINE,			F_CODECNV_EMAIL,		F_CODECNV_SJIS2JIS,	F_FILE_REOPEN_JIS,		F_0 }, },
	{ VK_F12,	L"F12",			{ F_HSP_JUMP_DEFINITION,	F_HSP_JUMP_ALL_REFERENCES,	F_HANKATATOZENHIRA,		F_0,				F_CODECNV_AUTO2SJIS,	F_0,				F_FILE_REOPEN_SJIS,		F_0 }, },
	...
	{ 'G',		L"G",			{ F_0,				F_0,				F_GREP_DIALOG,			F_HSP_OPEN_DOCUMENT,	F_0,					F_0,				F_0,					F_0 }, },
