...
static HBRUSH g_brBarBackground = CreateSolidBrush(RGB(40, 40, 40));
...
bool UAHWndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam, LRESULT& lr)
{
    ...
    case WM_UAHDRAWMENUITEM:
    {
        ...
        // ugly colors for illustration purposes
        static HBRUSH g_brItemBackground = CreateSolidBrush(RGB(40, 40, 40)); // 20 -> 40
        static HBRUSH g_brItemBackgroundHot = CreateSolidBrush(RGB(77, 77, 77));
        static HBRUSH g_brItemBackgroundSelected = CreateSolidBrush(RGB(65, 65, 65));
        ...
        DTTOPTS opts = { sizeof(opts), DTT_TEXTCOLOR, iTextStateID != MPI_DISABLED ? RGB(255, 255, 255) : RGB(204, 204, 204) };
